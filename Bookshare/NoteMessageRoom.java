...
public class NoteMessageRoom extends Frame implements ActionListener, KeyListener {
	...
	public List dr_lstMember; //접속자리스트
	public List nr_lstSender; //보낸사람리스트
	public List nr_lstTitle; //제목리스트
	String Data;
	...
	public NoteMessageRoom(ClientThread client, String title) {
		...
		nr_lstSender = new List(20);
		centerpanel.add("West",nr_lstSender);
		nr_lstSender.addItemListener(null);
		nr_lstTitle = new List(20);
		centerpanel.add("Center",nr_lstTitle);
		nr_lstTitle.addItemListener(null);
		...
		nr_Sendbtn.addActionListener(this);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (b.getLabel().equals("화면지우기")) {
			...
			dr_thread.requestSendNote(nr_NoteContents.getText(), nr_ReceiverField.getText(), nr_TitleField.getText());
		}
	}
